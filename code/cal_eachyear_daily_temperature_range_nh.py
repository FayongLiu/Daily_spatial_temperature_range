...
# this file is for calculating DSTR in north hemisphere based on ERA5-Land

# Initialize logging
logging.basicConfig(filename=r'/data1/fyliu/a_temperature_range/code/logging/data_processing_north_hemisphere.log', 
...
def cal_dstr(year):
    try:
        ...
        for tm in range(teststart, testend):
            ...
            da = dataset.t2m.sel(time = str(realtime), latitude = slice(90, 0))
...
def save_results(eyhmtr, eyhmaxt, eyhmint, year):
    ...
    outname = f'north_hemisphere_eachyear_maxTrange_{year}'
...
if __name__ == "__main__":
    ...
    outpath = r'/data1/fyliu/a_temperature_range/process_data/DSTR_original_list/north_hemisphere/'
