...
# this file is for calculating DSTR in globe based on ERA5-Land

# Initialize logging
logging.basicConfig(filename=r'/data1/fyliu/a_temperature_range/code/logging/data_processing_world.log', 
...
def save_results(eyhmtr, eyhmaxt, eyhmint, year):
    ...
    outname = f'world_eachyear_maxTrange_{year}'
...
if __name__ == "__main__":
    ...
    outpath = r'/data1/fyliu/a_temperature_range/process_data/DSTR_original_list/world/'
